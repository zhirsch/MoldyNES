  ...
  public NesCpuCycle decode(NesCpu cpu) {
    ...
    return switch (Byte.toUnsignedInt(opcode)) {
      ...
      case 0x01 -> new FetchIndirectX(new Ora());
        ...
        //      case 0x03 -> new Undocumented(new Slo(UInt8.cast(opcode)));
        //      case 0x04 -> new Undocumented(new FetchZeropage(new Nop()));
      case 0x05 -> new FetchZeropage(new Ora());
      case 0x06 -> new ReadModifyWriteZeropage(new Asl());
        //      case 0x07 -> new Undocumented(new Slo(UInt8.cast(opcode)));
      case 0x08 -> new Php();
      case 0x09 -> new FetchImmediate(new Ora());
      case 0x0a -> new ReadModifyWriteAccumulator(new Asl());
        //      case 0x0c -> new Undocumented(new FetchAbsolute(new Nop()));
      case 0x0d -> new FetchAbsolute(new Ora());
      case 0x0e -> new ReadModifyWriteAbsolute(new Asl());
        //      case 0x0f -> new Undocumented(new Slo(UInt8.cast(opcode)));
      case 0x10 -> new Bpl();
        //      case 0x11 -> new FetchIndirectY(new Ora(), new Ora.OnFinish());
        //      case 0x12 -> new Undocumented(new Hlt());
        //      case 0x13 -> new Undocumented(new Slo(UInt8.cast(opcode)));
        //      case 0x14 -> new Undocumented(new FetchZeropageX(new Nop()));
        //      case 0x15 -> new FetchZeropageX(new Ora(), new Ora.OnFinish());
        //      case 0x16 -> new Asl(UInt8.cast(opcode));
        //      case 0x17 -> new Undocumented(new Slo(UInt8.cast(opcode)));
      case 0x18 -> new Implied(new Clc());
        //      case 0x19 -> new FetchAbsoluteY(new Ora(), new Ora.OnFinish());
        //      case 0x1a -> new Undocumented(new Nop.Implied());
        //      case 0x1b -> new Undocumented(new Slo(UInt8.cast(opcode)));
        //      case 0x1c -> new Undocumented(new FetchAbsoluteX(new Nop()));
        //      case 0x1d -> new FetchAbsoluteX(new Ora(), new Ora.OnFinish());
        //      case 0x1e -> new Asl(UInt8.cast(opcode));
        //      case 0x1f -> new Undocumented(new Slo(UInt8.cast(opcode)));
      case 0x20 -> new Jsr();
      case 0x21 -> new FetchIndirectX(new And());
        //      case 0x22 -> new Undocumented(new Hlt());
        //      case 0x23 -> new Undocumented(new Rla(UInt8.cast(opcode)));
      case 0x24 -> new FetchZeropage(new Bit());
      case 0x25 -> new FetchZeropage(new And());
      case 0x26 -> new ReadModifyWriteZeropage(new Rol());
        //      case 0x27 -> new Undocumented(new Rla(UInt8.cast(opcode)));
      case 0x28 -> new Plp();
      ...
      case 0x2e -> new ReadModifyWriteAbsolute(new Rol());
        //      case 0x2f -> new Undocumented(new Rla(UInt8.cast(opcode)));
      case 0x30 -> new Bmi();
        //      case 0x31 -> new FetchIndirectY(new And(), new And.OnFinish());
        //      case 0x32 -> new Undocumented(new Hlt());
        //      case 0x33 -> new Undocumented(new Rla(UInt8.cast(opcode)));
        //      case 0x34 -> new Undocumented(new FetchZeropageX(new Nop()));
        //      case 0x35 -> new FetchZeropageX(new And(), new And.OnFinish());
        //      case 0x36 -> new Rol(UInt8.cast(opcode));
        //      case 0x37 -> new Undocumented(new Rla(UInt8.cast(opcode)));
      case 0x38 -> new Implied(new Sec());
        //      case 0x39 -> new FetchAbsoluteY(new And(), new And.OnFinish());
        //      case 0x3a -> new Undocumented(new Nop.Implied());
        //      case 0x3b -> new Undocumented(new Rla(UInt8.cast(opcode)));
        //      case 0x3c -> new Undocumented(new FetchAbsoluteX(new Nop()));
        //      case 0x3d -> new FetchAbsoluteX(new And(), new And.OnFinish());
        //      case 0x3e -> new Rol(UInt8.cast(opcode));
        //      case 0x3f -> new Undocumented(new Rla(UInt8.cast(opcode)));
      case 0x40 -> new Rti();
      case 0x41 -> new FetchIndirectX(new Eor());
        //      case 0x42 -> new Undocumented(new Hlt());
        //      case 0x43 -> new Undocumented(new Sre(UInt8.cast(opcode)));
        //      case 0x44 -> new Undocumented(new FetchZeropage(new Nop()));
      case 0x45 -> new FetchZeropage(new Eor());
      case 0x46 -> new ReadModifyWriteZeropage(new Lsr());
        //      case 0x47 -> new Undocumented(new Sre(UInt8.cast(opcode)));
      case 0x48 -> new Pha();
      ...
      case 0x4e -> new ReadModifyWriteAbsolute(new Lsr());
        //      case 0x4f -> new Undocumented(new Sre(UInt8.cast(opcode)));
      case 0x50 -> new Bvc();
        //      case 0x51 -> new FetchIndirectY(new Eor(), new Eor.OnFinish());
        //      case 0x52 -> new Undocumented(new Hlt());
        //      case 0x53 -> new Undocumented(new Sre(UInt8.cast(opcode)));
        //      case 0x54 -> new Undocumented(new FetchZeropageX(new Nop()));
        //      case 0x55 -> new FetchZeropageX(new Eor(), new Eor.OnFinish());
        //      case 0x56 -> new Lsr(UInt8.cast(opcode));
        //      case 0x57 -> new Undocumented(new Sre(UInt8.cast(opcode)));
        //      case 0x58 -> new Cli();
        //      case 0x59 -> new FetchAbsoluteY(new Eor(), new Eor.OnFinish());
        //      case 0x5a -> new Undocumented(new Nop.Implied());
        //      case 0x5b -> new Undocumented(new Sre(UInt8.cast(opcode)));
        //      case 0x5c -> new Undocumented(new FetchAbsoluteX(new Nop()));
        //      case 0x5d -> new FetchAbsoluteX(new Eor(), new Eor.OnFinish());
        //      case 0x5e -> new Lsr(UInt8.cast(opcode));
        //      case 0x5f -> new Undocumented(new Sre(UInt8.cast(opcode)));
      case 0x60 -> new Rts();
      case 0x61 -> new FetchIndirectX(new Adc());
        //      case 0x62 -> new Undocumented(new Hlt());
        //      case 0x63 -> new Undocumented(new Rra(UInt8.cast(opcode)));
        //      case 0x64 -> new Undocumented(new FetchZeropage(new Nop()));
      case 0x65 -> new FetchZeropage(new Adc());
      case 0x66 -> new ReadModifyWriteZeropage(new Ror());
        //      case 0x67 -> new Undocumented(new Rra(UInt8.cast(opcode)));
      case 0x68 -> new Pla();
      ...
      case 0x6e -> new ReadModifyWriteAbsolute(new Ror());
        //      case 0x6f -> new Undocumented(new Rra(UInt8.cast(opcode)));
      case 0x70 -> new Bvs();
        //      case 0x71 -> new FetchIndirectY(new Adc(), new Adc.OnFinish());
        //      case 0x72 -> new Undocumented(new Hlt());
        //      case 0x73 -> new Undocumented(new Rra(UInt8.cast(opcode)));
        //      case 0x74 -> new Undocumented(new FetchZeropageX(new Nop()));
        //      case 0x75 -> new FetchZeropageX(new Adc(), new Adc.OnFinish());
        //      case 0x76 -> new Ror(UInt8.cast(opcode));
        //      case 0x77 -> new Undocumented(new Rra(UInt8.cast(opcode)));
      case 0x78 -> new Implied(new Sei());
        //      case 0x79 -> new FetchAbsoluteY(new Adc(), new Adc.OnFinish());
        //      case 0x7a -> new Undocumented(new Nop.Implied());
        //      case 0x7b -> new Undocumented(new Rra(UInt8.cast(opcode)));
        //      case 0x7c -> new Undocumented(new FetchAbsoluteX(new Nop()));
        //      case 0x7d -> new FetchAbsoluteX(new Adc(), new Adc.OnFinish());
        //      case 0x7e -> new Ror(UInt8.cast(opcode));
        //      case 0x7f -> new Undocumented(new Rra(UInt8.cast(opcode)));
        //      case 0x80 -> new Undocumented(new FetchImmediate(new Nop()));
      ...
      case 0x88 -> new Implied(new Dey());
        //      case 0x89 -> new Undocumented(new FetchImmediate(new Nop()));
      ...
      case 0xa2 -> new FetchImmediate(new Ldx());
        //      case 0xa3 -> new Undocumented(new FetchIndirectX(new Lax()));
      case 0xa4 -> new FetchZeropage(new Ldy());
      case 0xa5 -> new FetchZeropage(new Lda());
      case 0xa6 -> new FetchZeropage(new Ldx());
        //      case 0xa7 -> new Undocumented(new FetchZeropage(new Lax()));
      ...
      case 0xce -> new ReadModifyWriteAbsolute(new Dec());
        //      case 0xcf -> new Undocumented(new Dcp(UInt8.cast(opcode)));
      case 0xd0 -> new Bne();
        //      case 0xd1 -> new FetchIndirectY(new Cmp(), new Cmp.OnFinish());
        //      case 0xd2 -> new Undocumented(new Hlt());
        //      case 0xd3 -> new Undocumented(new Dcp(UInt8.cast(opcode)));
        //      case 0xd4 -> new Undocumented(new FetchZeropageX(new Nop()));
        //      case 0xd5 -> new FetchZeropageX(new Cmp(), new Cmp.OnFinish());
        //      case 0xd6 -> new Dec(UInt8.cast(opcode));
        //      case 0xd7 -> new Undocumented(new Dcp(UInt8.cast(opcode)));
      case 0xd8 -> new Implied(new Cld());
        //      case 0xd9 -> new FetchAbsoluteY(new Cmp(), new Cmp.OnFinish());
        //      case 0xda -> new Undocumented(new Nop.Implied());
        //      case 0xdb -> new Undocumented(new Dcp(UInt8.cast(opcode)));
        //      case 0xdc -> new Undocumented(new FetchAbsoluteX(new Nop()));
        //      case 0xdd -> new FetchAbsoluteX(new Cmp(), new Cmp.OnFinish());
        //      case 0xde -> new Dec(UInt8.cast(opcode));
        //      case 0xdf -> new Undocumented(new Dcp(UInt8.cast(opcode)));
      case 0xe0 -> new FetchImmediate(new Cpx());
      case 0xe1 -> new FetchIndirectX(new Sbc());
        //      case 0xe3 -> new Undocumented(new Isb(UInt8.cast(opcode)));
      case 0xe4 -> new FetchZeropage(new Cpx());
      case 0xe5 -> new FetchZeropage(new Sbc());
      case 0xe6 -> new ReadModifyWriteZeropage(new Inc());
        //      case 0xe7 -> new Undocumented(new Isb(UInt8.cast(opcode)));
      case 0xe8 -> new Implied(new Inx());
      case 0xe9 -> new FetchImmediate(new Sbc());
      case 0xea -> new Implied(new Nop());
        //      case 0xeb -> new Undocumented(new FetchImmediate(new Sbc()));
      case 0xec -> new FetchAbsolute(new Cpx());
      case 0xed -> new FetchAbsolute(new Sbc());
      case 0xee -> new ReadModifyWriteAbsolute(new Inc());
        //      case 0xef -> new Undocumented(new Isb(UInt8.cast(opcode)));
      case 0xf0 -> new Beq();
        //      case 0xf1 -> new FetchIndirectY(new Sbc(), new Sbc.OnFinish());
        //      case 0xf2 -> new Undocumented(new Hlt());
        //      case 0xf3 -> new Undocumented(new Isb(UInt8.cast(opcode)));
        //      case 0xf4 -> new Undocumented(new FetchZeropageX(new Nop()));
        //      case 0xf5 -> new FetchZeropageX(new Sbc(), new Sbc.OnFinish());
        //      case 0xf6 -> new Inc(UInt8.cast(opcode));
        //      case 0xf7 -> new Undocumented(new Isb(UInt8.cast(opcode)));
      case 0xf8 -> new Implied(new Sed());
        //      case 0xf9 -> new FetchAbsoluteY(new Sbc(), new Sbc.OnFinish());
        //      case 0xfa -> new Undocumented(new Nop.Implied());
        //      case 0xfb -> new Undocumented(new Isb(UInt8.cast(opcode)));
        //      case 0xfc -> new Undocumented(new FetchAbsoluteX(new Nop()));
        //      case 0xfd -> new FetchAbsoluteX(new Sbc(), new Sbc.OnFinish());
        //      case 0xfe -> new Inc(UInt8.cast(opcode));
        //      case 0xff -> new Undocumented(new Isb(UInt8.cast(opcode)));
