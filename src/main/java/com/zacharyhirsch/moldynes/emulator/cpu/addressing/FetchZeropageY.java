...
public class FetchZeropageY implements NesCpuCycle {

  private final FetchInstruction instruction;

  public FetchZeropageY(FetchInstruction instruction) {
  ...
  private NesCpuCycle cycle3(NesCpu cpu) {
    cpu.fetch((byte) 0x00, (byte) (cpu.state.adl + cpu.state.y));
    return this::cycle4;
  }
